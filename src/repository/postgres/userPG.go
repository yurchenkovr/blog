...
func (a *userRepository) Update(id int, user models.User) error {
...
func (a *userRepository) View(id int) (*models.User, error) {
	var user = new(models.User)
	...
	if err != nil {
		log.Printf("ERROR while View, Reason: %v\n", err)
		return nil, err
	}
...
func (a *userRepository) Delete(id int) error {
...
func (a *userRepository) List() ([]models.User, error) {
	var user []models.User
